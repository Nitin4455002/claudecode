# RankFrame: The Master Reference

**The first and only native SEO plugin built for Framer.**

This document is the complete, detailed source of truth for everything RankFrame is, everything it does, and how every part of it works. It exists so anyone (a marketer, a support agent, a partner, an investor, an AI assistant, a new hire) can read this single file and walk away knowing the entire product.
...
**Position change indicator:** green up arrow with delta when ranking improves (e.g. 2.4 ▲ 0.3 means current position 2.4 is 0.3 better than previous reading).
